...
import { ArrowUp, ArrowDown, Book, X } from 'lucide-react';
...
const CollectionItem: React.FC<CollectionItemProps> = ({ item, onRemoveFromFolder }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="bg-white p-3 rounded-md shadow-sm flex items-center gap-3 cursor-move border border-gray-200"
      {...attributes}
      {...listeners}
    >
